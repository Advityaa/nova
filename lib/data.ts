...
export const NEWS: NewsItem[] = [
  {
    href: "https://www.smartshanghai.com/event/nova-events-presents-summer-splash-pool-party-2026-06-27",
    tag: "Pool Party",
    title: "Summer Splash Pool Party",
    body: "Nova Events takes over the pool with an epic summer splash event, featuring top DJs and signature cocktails.",
  },
  {
    href: "https://www.smartshanghai.com/event/bellagio-rooftop-season-opening-party-at-bellagio-shanghai-1",
    tag: "Rooftop",
    title: "Bellagio Rooftop Season Opening",
    body: "Kicking off the summer rooftop season at the luxurious Bellagio Shanghai with breathtaking views and elite vibes.",
  },
  {
  ...
  {
    href: "https://www.smartshanghai.com/event/rang-barse-festival-of-colors-on-the-bund-2026-03-21",
    tag: "Festival",
    title: "Rang Barse: Festival of Colors",
    body: "Celebrating Holi on the Bund with vibrant colors, Bollywood beats, and an unforgettable cultural experience.",
  },
  {
    href: "https://www.smartshanghai.com/event/ke-de-ta-sessions-rooftop-beach-club-party-by-nova-events",
    tag: "Beach Club",
    title: "Ke De Ta Sessions",
    body: "A rooftop beach club party bringing the tropical vibes of Bali straight to the heart of Shanghai.",
  },
  {
    href: "https://www.smartshanghai.com/event/blacklist-rooftop-party-on-the-bund-at-skyline-dome-sushi-rooftop-lounge",
    tag: "Rooftop",
    title: "Blacklist Rooftop Party",
    body: "An exclusive night at Skyline Dome Sushi Rooftop Lounge on the Bund with premium house and techno.",
  },
  {
    href: "https://www.smartshanghai.com/event/nova-events-presents-tribeat-vue-bar-rooftop-party-at-vue-bar-2026-04-04",
    tag: "Rooftop",
    title: "Tribeat at Vue Bar",
  ...
  {
    href: "https://www.smartshanghai.com/event/nova-events-presents-sunset-sessions-flair-rooftop-party-2026-06-13-2",
    tag: "Rooftop",
    title: "Sunset Sessions at Flair",
    body: "Golden hour vibes at Flair Rooftop, pairing the iconic Pearl Tower view with smooth beats and crafted drinks.",
  },
  {
    href: "https://www.smartshanghai.com/event/epic-oasis-bellagio-rooftop-party-2026-06-06",
    tag: "Rooftop",
    title: "Epic Oasis Bellagio Rooftop",
    body: "Transforming the Bellagio Terrace into a lush oasis for an unforgettable night of music and luxury.",
  },
  {
    href: "https://www.smartshanghai.com/event/golden-hour-new-year-s-eve-party-by-nova-events-at-park-hyatt-2025-12-31",
    tag: "NYE",
    title: "Golden Hour NYE at Park Hyatt",
    body: "Ringing in the New Year high above the clouds at Park Hyatt with a premium crowd and unmatched energy.",
  },
  {
    href: "https://www.smartshanghai.com/event/nova-events-presents-pole-position-racing-weekend-party-2026-03-14",
    tag: "Racing",
    title: "Pole Position Racing Weekend",
    body: "Revving up the excitement for race weekend with high-octane entertainment and exclusive VIP hospitality.",
  },
  {
    href: "https://www.smartshanghai.com/event/nova-events-presents-urban-oasis-urban-oasis-rooftop-season-opening-2026-03-07",
    tag: "Rooftop",
    title: "Urban Oasis Season Opening",
    body: "A spectacular season opening event creating an urban sanctuary above the bustling streets of Shanghai.",
  },
  {
    href: "https://www.smartshanghai.com/event/the-timeless-vue-2026-nye-countdown-party-by-nova-events-at-vue-bar-2025-12-31",
    tag: "NYE",
    title: "The Timeless Vue NYE",
    body: "A classic New Year's Eve countdown overlooking the historic Bund skyline at the legendary Vue Bar.",
  }
];
